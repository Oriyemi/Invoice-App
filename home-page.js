document.addEventListener("DOMContentLoaded", () => {
    ...
    function createItemRow() {
        ...
        item.className =
            "grid grid-cols-12 gap-4 items-center mb-4 item-row";
        ...
        item.innerHTML = `
            <div class="col-span-5">
                <input 
                    ...
                    class="w-full border border-[#7E88C3] p-2 rounded dynamic-bg dynamic-sub-text item-name"
                    required
                >
            </div>
            ...
            <div class="col-span-2">
                <input 
                    type="text"
                    class="w-full border border-[#7E88C3] p-2 rounded dynamic-bg dynamic-sub-text item-qty" required
                >
            </div>
            ...
            <div class="col-span-2">
                <input 
                    type="text"
                    class="w-full border border-[#7E88C3] p-2 rounded dynamic-bg dynamic-sub-text item-price" required
                >
            </div>
    ...
    function renderInvoices() {
        ...
        allInvoices.forEach((inv, index) => {
            ...
            card.className =
                "dynamic-text dynamic-sub-text dynamic-bg  p-6 rounded-lg shadow-sm flex items-center sm:w-[672px] lg:w-[730px] h-[72px] justify-between border border-transparent hover:border-[#7C5DFA] mb-4 font-['League_Spartan'] font-medium text-[13px] leading-[15px] tracking-[-0.1px]";
